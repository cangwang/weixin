...
class AppDelegate: UIResponder, UIApplicationDelegate,XMPPStreamDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.le.weixin" in the application's documents Application Support directory.
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("weixin.sqlite")
